...
public class NdaConst {
    public static final String NDAITEM_TPL = "<p><strong><strong>保密合同</strong></strong></p>\n" +
            "\n" +
    ...
    public final static Map<String, String> NDA_SHARESTATUSMAP4INITIATOR = new HashMap<String, String>() {
        {
            put("交易请求",      "0");
            put("活动交易",      "1");
            put("我方中止",      "2");
    ...
    public final static Map<String, String> NDA_SHARESTATUSMAP4PARTNER = new HashMap<String, String>() {
        {
            put("交易请求",     "0");
            put("活动交易",      "1");
            put("对方中止",      "2");
    ...
    public final static Map<String, String> NDA_CREATENDAWITHFILE = new HashMap<String, String>() {
        {
            put("有",     "1");
            put("无",     "2");
        }
